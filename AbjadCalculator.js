...
if (this.indexOf('p') > -1){var p = this.split("p").join("87").match(/(87)/gim).map(Number).reduce(getSum)}else{p=0}
if (this.indexOf('Q') > -1){var Q = this.split("Q").join("120").match(/(120)/gim).map(Number).reduce(getSum)}else{Q=0}
if (this.indexOf('q') > -1){var q = this.split("q").join("120").match(/(120)/gim).map(Number).reduce(getSum)}else{q=0}
if (this.indexOf('R') > -1){var R = this.split("R").join("100").match(/(100)/gim).map(Number).reduce(getSum)}else{R=0}
if (this.indexOf('r') > -1){var r = this.split("r").join("100").match(/(100)/gim).map(Number).reduce(getSum)}else{r=0}
if (this.indexOf('S') > -1){var S = this.split("S").join("60").match(/(60)/gim).map(Number).reduce(getSum)}else{S=0}
if (this.indexOf('s') > -1){var s = this.split("s").join("60").match(/(60)/gim).map(Number).reduce(getSum)}else{s=0}
if (this.indexOf('T') > -1){var T = this.split("T").join("300").match(/(300)/gim).map(Number).reduce(getSum)}else{T=0}
if (this.indexOf('t') > -1){var t = this.split("t").join("300").match(/(300)/gim).map(Number).reduce(getSum)}else{t=0}
if (this.indexOf('U') > -1){var U = this.split("U").join("400").match(/(400)/gim).map(Number).reduce(getSum)}else{U=0}
if (this.indexOf('u') > -1){var u = this.split("u").join("400").match(/(400)/gim).map(Number).reduce(getSum)}else{u=0}
